...
-- legacy-schema.sql
--
-- Frozen snapshot of db/schema.sql as it stood when the Phinx database
-- migration system was introduced in 2026. This file is loaded by the
-- InitialSchema migration (20260530000000_initial_schema.php) to bootstrap
-- the baseline schema on fresh installs.
--
-- DO NOT EDIT this file. All subsequent schema changes must be made as new
-- Phinx migrations under db/migrations/. The canonical, evolving schema lives
-- in db/schema.sql; this copy is intentionally fixed so that the initial
-- migration remains reproducible over time.
--
