    ...
    <form action="./" method="post">
        <p>
            <label for="recmail">Their email:</label> <input type="text" name="recipient_mail" id="recmail"
                value="<?php echo $recipient_email ?>" size="30">
            <br><label for="sendmail">Your email:</label> <input type="text" id="sendmail" name="sender_mail"
                value="<?php echo $sender_email ?>" size="30">
            <br><label for="sendname">Your name:</label> <input type="text" id="sendname" name="sender_name"
                value="<?php echo $sender_name ?>" size="30">
            <input type="hidden" name="pid" value="<?php echo $pid ?>">
            <br>(<a href="<?php echo WEBPATH ?>/privacy/">privacy policy</a>)
