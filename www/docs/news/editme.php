...
$all_news = [
  16 => ['Register of Senators\' Interests update - June 2010', <<<EOT
...
, '2010-06-25 15:05:00', 'Matthew'
  ...
  15 => ['Kevin Rudd surrenders his Cuban cigars. But who gets to smoke them?', <<<EOT
...
, '2010-05-03 12:30:00', 'Matthew'
  ...
  14 => ['Register of Senators\' Interests updated', <<<EOT
...
, '2010-03-09 09:52:00', 'Matthew'
  ...
  13 => ['Calling OpenAustralia volunteers', <<<EOT
...
, '2009-10-22 22:03:00', 'Henare'
  ...
  12 => ['OpenAustralia Goes Mobile and Gets Social', <<<EOT
...
, '2009-09-29 12:58:00', 'Henare'
  ...
  11 => ['Our new home on Facebook', <<<EOT
...
, '2009-05-12 16:30:00', 'Matthew'
  ...
  10 => ['Opening up the procedures of Parliament', <<<EOT
...
, '2009-05-06 18:15:00', 'Kat'
  ...
  9 => ['Another big step forward for government transparency in Australia', <<<EOT
...
, '2009-02-26 08:30:00', 'Matthew'
  ...
  8 => ['Multiple email alerts over the last few days', <<<EOT
...
, '2009-02-19 17:29:00', 'Matthew'
  ...
  7 => ['Read the Register of Senators\' Interests here', <<<EOT
...
, '2009-01-05 11:05:00', 'Matthew'
  ...
  6 => ['Government website changes everything', <<<EOT
...
, '2008-11-03 23:57:00', 'Matthew'
  ...
  5 => ['A new look OpenAustralia', <<<EOT
...
, '2008-08-17 19:40:00', 'Katherine'
  ...
  3 => ['OpenAustralia behind the scenes', <<<EOT
...
, '2008-07-06 19:56:00', 'Matthew'
  ...
  2 => ['Photos on all representatives page', <<<EOT
...
, '2008-07-06 19:35:00', 'Matthew'
  ...
  1 => ['Public Launch of OpenAustralia Beta', <<<EOT
