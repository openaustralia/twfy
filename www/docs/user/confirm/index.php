...
if (get_http_var('welcome') == 't') {
    ...
    if ($THEUSER->isloggedin()) {
        ...
        <p>Feel free to use it to keep an eye on <strong>your Representative</strong>, add <strong>comments</strong> next to
            speeches, or help others by contributing your own <strong>links</strong>.</p>

        <p><strong>OpenAustralia.org</strong> is currently being <strong>beta tested</strong>, so <a
...
function confirm_error()
{
    ...
    <p>If you clicked a link in your confirmation email you may need to manually copy and paste the entire link to the
        'Location' bar of the web browser and try again.</p>

    <p>If you still get this message, please do <a href="mailto:<?php echo CONTACTEMAIL; ?>">email us</a> and let us know,
        and we'll help out!</p>
