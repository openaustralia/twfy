...
<p>
    ...
    If you know any more IP addresses for political organisations we could add, do <a
        href="mailto:beta&#64;openaustralia.org">let us know at the usual address</a>.</p>
<p>And we haven't even touched on people <a href="http://www.masonskill.co.uk/">sending emails from a Parliament
        computer winding up a Freemason conspiracy theorist</a>...</p>
<p align="center">
    <?php
    $out = [];
    foreach ($site as $k => $v) {
