...
$link_to_us_form .= <<<END
" method="get">
		<label style="display: block; font-size: small; font-weight: bold; margin: 0 0 9px 0;" for="pc">Find out more about your <abbr class="display: inline; speak: spell-out;" title="Representative">Representative</abbr></label>
		<input id="pc" name="pc" style="width: 12em; border: solid 1px #AE967F;" title="Enter your Australian postcode here" tabindex="1" type="text" size="8" maxlength="20" value="Your Postcode"> 
		<input id="Submit1" name="Submit1" style="border: solid 0px #AE967F; background-color: #AE967F; color: #ffffff; font-weight: bold; text-transform: uppercase;" title="Submit search" tabindex="2" type="submit" value="Go">
	</form>
...
" method="get">
		...
		<input id="s" name="s" style="width: 12em; border: solid 1px #AE967F;" title="Type what you're looking for" type="text" tabindex="3" size="15" maxlength="100" value="Your Search">
		<input id="Submit2" name="Submit2" style="border: solid 0px #AE967F; background-color: #AE967F; color: #ffffff; font-weight: bold; text-transform: uppercase;" title="Submit search" tabindex="4" type="submit" value="Go">
		<br>
	</form>
</div> 
