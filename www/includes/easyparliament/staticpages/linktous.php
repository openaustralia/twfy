...
<p>Alternatively, if you would like to place a OpenAustralia search box on your site, like this one&hellip;</p>
...
<div style="position: relative; width: 17em; color: #000000; background-color: #E8FDCB; font-family: Arial, Geneva, Sans-serif; margin-bottom: 1em; border: 1px solid #4d6c25; padding: 0 10px 2em 10px;">
	<h5 style="font-family: Arial, Geneva, Sans-serif; font-size: 1.4em; position: absolute; margin: 0; bottom: 2px; right: 10px;"  title="OpenAustralia.org"><a style="color: #880101; text-decoration: none; font-weight: normal;" href="http://www.OpenAustralia.org"><em style="font-weight: bold; font-style: normal;">TheyWorkFor</em><strong style="color: #cc0000; font-weight: bolder;">You</strong>.com</a></h5>
	<form style="margin: 0; padding: 5px 0 0 0;" title="Find out about your Representative" action="http://www.openaustralia.org/mp/" method="get">
	...
	<form style="margin: 0; padding: 5px 0 0 0;" title="Search everything said in Parliament since 2001" action="http://www.openaustralia.org/search/" method="get">
...
<p>Please retain the link to <a href="http://www.openaustralia.org">openaustralia.org</a> (Google points mean prizes). Any questions, just drop us a line at: <a href="http://www.openaustralia.org/contact/">http://www.openaustralia.org/contact/</a>
</p>
