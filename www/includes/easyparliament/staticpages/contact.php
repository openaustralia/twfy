...
<p>The email address of OpenAustralia.org, which is run by a <strong>charity</strong>, is: <a href="mailto:<?php echo str_replace('@', '&#64;', CONTACTEMAIL); ?>"><?php echo str_replace('@', '&#64;', CONTACTEMAIL); ?></a></p>
