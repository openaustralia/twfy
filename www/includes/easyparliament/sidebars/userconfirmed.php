...
<p>Before you add a comment, please read our <a href="<?php echo $houserulesurl; ?>">House Rules</a> for advice on the
    kind of language, tone and behaviour we want to encourage.</p>
