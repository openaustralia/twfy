...
class PAGE {
     ...
     *
     */
    public function page_start_mobile() {
        ob_start();
        set_time_limit(0);
        global $DATA, $this_page, $THEUSER;
     ...
     *
     */
    public function page_end_mobile() {
     ...
     *
     */
    public function page_header_mobile() {
     ...
     *
     */
    public function page_body_mobile() {
        global $this_page;
    ...
    public function title_bar() {
        ...
        $img = '<img src="' . IMAGEPATH . 'openaustraliaorg2026.png" width="262" height="32" alt="OpenAustralia.org">';
     ...
     *
     */
    public function title_bar_mobile() {
        // The title bit of the page, with possible search box.
        global $this_page;
     ...
     *
     */
    public function user_bar($top_hilite = '', $bottom_hilite = '') {
    ...
    public function content_end() {
        ...
        ?>
                    ...
                    <?php
                    // bg-[#26343b]: the same navy as the nav bar and the front page's
                    // search hero (see docs/index.php's search_hero()) - matches
                    // Donna's homepage mockup's own dark footer
                    // (https://kattekrab.github.io/openausmockup.html), just in this
                    // site's navy rather than the mockup's plain gray-800. Link colours
                    // throughout: !text-teal-300 at rest, hover:!text-white, same
                    // convention search_hero()'s "Popular searches" links already use on
                    // this navy - !-prefixed because layout.css's legacy "a:link"/
                    // "a:visited" rules (specificity 0,1,1) beat a plain colour class
                    // (0,1,0) regardless of stylesheet order. The old footer never had
                    // this fix, so every link in it rendered classic underlined blue
                    // against a light grey background - not actually this site's
                    // colours at all.
                    ?>
    ...
    public function postcode_form() {
        ...
        <br>
        <?php
        $this->block_start(['id' => 'mp', 'title' => 'Find out about your Representative']);
        ?>
...
';
    ...
    public function display_member($member, $extra_info) {
        ...
        ?> <a name="numbers"></a>
        <?php
        $this->block_start(['id' => 'numbers', 'title' => 'Numbers']);
        $displayed_stuff = 0;
        ?>
        ...
        if ($member['current_member'][1] || $member['current_member'][2]) {
            ...
            <a name="register"></a>
            <?php
            $this->block_start(['id' => 'register', 'title' => 'Register of Interests <small>(<a href="' . WEBPATH . 'help/#regmem">What\'s this?</a>)</small>']);
