...
<?php
	...
	?>
		...
		<?
			$got_dream = false;
			$got_dream |= display_dream_comparison($extra_info, $member, 1, "same-sex marriage equality", false, "");
			...
			$got_dream |= display_dream_comparison($extra_info, $member, 13, "increasing or removing the Government debt limit", false, "");
			...
			$got_dream |= display_dream_comparison($extra_info, $member, 32, "live animal export", false, "");
			...
			$got_dream |= display_dream_comparison($extra_info, $member, 46, "increasing access under Freedom of Information law", false, "");
			...
			$got_dream |= display_dream_comparison($extra_info, $member, 51, "offshore processing for people seeking asylum in Australia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 53, "increasing freedom of political communication", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 54, "storing all citizens' telecommunications data for access by government agencies", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 55, "requiring a warrant to access citizens’ telecommunications records", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 56, "decreasing ABC and SBS funding", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 57, "tighter means testing of family payments ", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 58, "deregulating undergraduate university fees", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 59, "increasing accessibility of government data and documents", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 60, "removing children from immigration detention", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 61, "funding the national school chaplaincy program", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 62, "landholders' right to say no to mining and gas exploration", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 63, "building Australia’s new submarine fleet in South Australia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 65, "compensating victims of overseas terrorism since the September 11 attack", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 66, "giving apprentices access to a $20,000 loan", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 67, "protecting whales within Australian waters", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 68, "increasing the diversity of media ownership", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 69, "increasing support for community radio and TV", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 70, "increasing indexation of HECS-HELP debts", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 71, "charging postgraduate research students fees", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 72, "decreasing the gender pay gap", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 73, "greater public scrutiny of the Trans-Pacific Partnership negotiations", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 75, "increasing transparency of the China-Australia relationship", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 77, "the Trans-Pacific Partnership (TPP) Agreement", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 78, "requiring Parliamentary approval of military deployments", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 79, "treating government action on climate change as a matter of urgency", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 81, "increasing transparency of big business by making information public", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 82, "making Australians working overseas repay their student debts", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 83, "letting environmental groups challenge the legality of certain government decisions", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 84, "revoking citizenship of dual nationals involved with terrorism offences by the minister", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 85, "restricting donations to political parties", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 86, "creating a federal Anti-Corruption Commission", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 87, "withdrawing troops from Afghanistan", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 88, "using natural resource wealth for the benefit of all Australians", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 89, "Senate electoral reform", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 90, "protecting whistleblowers", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 91, "a fast transition from fossil fuels to renewable energy", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 92, "stopping tax avoidance or aggressive tax minimisation", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 93, "ending illegal logging", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 94, "protecting threatened forest and bushland habitats", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 95, "a Royal Commission into banking", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 96, "a review of parliamentary entitlements", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 97, "the use of strong encryption technologies", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 98, "increasing parliamentary entitlements for current MPs and Senators", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 99, "increasing the foreign aid budget to 0.7% of Gross National Income", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 101, "removing parallel import restrictions for books", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 102, "local community consultation on infrastructure projects", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 103, "a plebiscite on the carbon pricing mechanism", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 104, "maintaining or increasing CSIRO funding", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 105, "increasing funding for legal aid", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 107, "buffer zones around abortion clinics", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 109, "putting welfare payments onto cashless debit cards (or indue cards) on a temporary basis as a trial", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 110, "a publicly accessible foreign ownership register for agricultural land", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 112, "speeding things along in Parliament (procedural)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 113, "suspending the rules to allow a vote to happen (procedural)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 114, "letting all MPs or Senators speak in Parliament (procedural)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 115, "high speed rail on the east coast", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 116, "federal action on public housing", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 117, "increasing housing affordability", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 118, "ending immigration detention on Nauru", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 119, "imprisoning immigration detention workers who record or reveal information from their work", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 120, "putting a time limit on immigration detention", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 121, "ending immigration detention on Manus Island", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 122, "protecting the Great Barrier Reef", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 123, "public transport", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 124, "increasing the price of tobacco", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 125, "a national redress scheme for institutional abuse survivors", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 126, "strengthening gun control laws", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 127, "the Australian Renewable Energy Agency (ARENA)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 128, "protecting citizens' privacy", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 129, "a same-sex marriage plebiscite", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 131, "increasing the initial tax rate for working holiday makers to 19%", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 132, "an Australian Building and Construction Commission (ABCC)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 133, "increasing scrutiny of unions", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 134, "stopping people who arrive by boat from ever coming to Australia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 135, "Preventative Detention Orders (PDOs)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 136, "increasing the passenger movement charge ('PMC')", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 137, "more scrutiny of the Australian Defence Force", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 138, "increasing the initial tax rate for working holiday makers to 15%", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 139, "Continuing Detention Orders (CDOs)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 141, "increasing investment in the coal industry", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 142, "a Free Trade Agreement with China", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 143, "banning all investment in cluster munitions", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 144, "changing the date of Australia Day", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 145, "doctor-initiated medical transfers for asylum seekers", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 146, "getting rid of the Gold Travel Pass", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 147, "changing the wording of section 18C of the Racial Discrimination Act", false, "");
			...
			$got_dream |= display_dream_comparison($extra_info, $member, 163, "drug testing welfare recipients", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 164, "equal treatment for all couples", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 165, "refugee family reunification", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 166, "a citizenship test", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 168, "privatising government services", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 169, "increasing the Medicare Levy to pay for the National Disability Insurance Scheme", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 170, "a review of our representatives' eligibility", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 171, "increasing federal government support for childcare", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 172, "government action on animal & plant extinctions", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 174, "turning back asylum boats when possible", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 175, "civil celebrants having the right to refuse to marry same-sex couples", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 176, "universal access to abortion services", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 178, "expanding Medicare-funded dental care", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 179, "increasing the Newstart Allowance rate", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 180, "an inquiry into the Iraq War", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 182, "greater control over items brought into immigration detention centres", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 183, "the Paris Climate Agreement", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 184, "increasing eligibility requirements for Australian citizenship", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 185, "making more water from Murray-Darling Basin available to use", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 186, "privatising the ABC", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 187, "targeting foreign interference in Australia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 188, "increasing penalties for breach of data", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 189, "a declared area offence", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 190, "legalising euthanasia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 192, "stopping former ministers from taking lobbying positions within five years", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 194, "promoting multiculturalism", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 195, "increasing legal protections for LGBTI people", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 196, "nuclear energy", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 198, "prioritising religious freedom", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 199, "increasing political transparency", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 200, "a travel ban on people from certain countries", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 201, "MacMines' proposed China Stone coal mine in the Galilee Basin", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 202, "a combined Federal Circuit and Family Court of Australia", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 203, "political interference in research funding", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 204, "protecting Australian sovereignty in trade agreements", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 206, "pill testing", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 207, "legalising pepper spray", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 208, "increasing government support for the dairy industry", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 212, "ending Governor-General allowances for serious misconduct", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 214, "transgender rights", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 216, "community right to say no to nuclear waste disposal sites", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 217, "Australia's timber industry", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 218, "reducing personal income tax", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 219, "for increasing the Youth Allowance rate", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 220, "Temporary Exclusion Orders", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 221, "making the cashless debit card program voluntary", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 222, "banning new thermal coal mines", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 225, "reducing air pollution", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 226, "an independent NDIS assessment process", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 227, "investing in climate science", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 228, "building community climate change resilience", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 231, "offshore oil mining", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 232, "increasing funding for vocational education", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 235, "increasing access to the JobKeeper Payment", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 236, "assisting the Arts sector through the coronavirus pandemic", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 237, "parliament continuing to meet during the COVID-19 pandemic", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 238, "mandatory minimum sentences for certain offences", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 240, "paid parental leave equality for stay-at-home mums and dads", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 241, "increasing funding for public schools", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 243, "a Royal Commission into Robodebt", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 244, "banning mobiles and other devices in immigration detention", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 245, "increasing state and territory environmental approval powers", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 246, "increasing the cost of humanities degrees", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 248, "the Murray Darling Basin Plan", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 249, "assisting Australians trying to return from overseas", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 253, "extending Jobkeeper Payment", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 255, "increasing protections for franchisees", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 256, "an independent inquiry into Attorney-General Christian Porter", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 257, "a constitutionally enshrined First Nations Voice in parliament", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 258, "implementing the recommendations of the Royal Commission into Aboriginal Deaths in Custody", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 261, "increasing support for the Australian film and TV industry", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 263, "building dedicated quarantine facilities (COVID-19)", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 264, "treating the COVID vaccine rollout as a matter of urgency", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 267, "increasing workplace protections for women", false, "");
			$got_dream |= display_dream_comparison($extra_info, $member, 276, "putting welfare payments onto cashless debit cards (or indue cards) on an ongoing basis", false, "");
			if (!$got_dream) {
