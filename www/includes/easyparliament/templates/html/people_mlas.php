...
<table border="0" cellpadding="4" cellspacing="0" width="90%" class="people oa-people-table">
    <caption class="oa-sr-only">List of MLAs by name, party, and constituency</caption>
    <thead>
        <tr>
...
function render_mps_row($mp, &$style, $order, $MPURL)
{
    ...
    $url = $MPURL->generate() . make_member_url($mp['first_name'] . ' ' . $mp['last_name'], $mp['constituency'], 3);
