...
>>>>>>> Initial muiltipart html email for alerts:scripts/alertmailer.php
		if ($q->rows() > 0) {
...
<<<<<<< HEAD:scripts/alertmailer.php
			...
			$q = $db->query('SELECT gid_from FROM gidredirect WHERE gid_to=\'uk.org.publicwhip/' . $sects_short[$major] . '/' . mysql_real_escape_string($row['gid']) . "'");
=======
			//mlog($row['major'] . " " . $row['gid'] ."\n");
